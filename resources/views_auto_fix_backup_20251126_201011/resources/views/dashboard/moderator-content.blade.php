            ...
            <div class="card-body">
                @forelse($contenusAValider as $contenu)
                    <div class="border-bottom pb-3 mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('contenus.valider', $contenu->id_contenu) }}" 
                                   class="btn btn-sm btn-success" 
                                   onclick="return confirm('Valider ce contenu ?')">
                                    <i class="bi bi-check"></i>
                                </a>
                                <a href="{{ route('contenus.rejeter', $contenu->id_contenu) }}" 
                ...
                @if($contenusAValider->count() > 0)
                    <div class="text-center mt-3">
                        <a href="{{ route('contenu.a-valider') }}" class="btn btn-warning btn-sm">

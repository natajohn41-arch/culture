            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ route('typemedia.edit', $typeMedia->id_type_media) }}" 
                        ...
                        <a href="{{ route('typemedia.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header bg-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('media.index') }}?type={{ $typeMedia->id_type_media }}" 

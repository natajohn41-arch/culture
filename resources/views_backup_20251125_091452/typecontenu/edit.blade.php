...
<html lang="fr">
  ...
  <div class="row justify-content-center w-100">
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">Éditer le type</div>
        <div class="card-body">
          @if($errors->any())
          ...
          <form action="{{ route('typecontenu.update', $role->id_type_contenu) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-3">
              <label for="nom_contenu" class="form-label">Nom</label>
              <input type="text" name="nom_contenu" id="nom_contenu" value="{{ old('nom_contenu', $role->nom_contenu) }}" class="form-control" required>
            </div>

            <div class="d-flex justify-content-end">
              <a href="{{ route('typecontenu.index') }}" class="btn btn-secondary me-2" title="Annuler" aria-label="Annuler"><i class="bi bi-x-lg"></i></a>

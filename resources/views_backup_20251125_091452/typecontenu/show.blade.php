      ...
      <div class="card">
        ...
        <div class="card-body">
          <dl class="row">
            ...
            <dd class="col-sm-8">{{ $role->id_type_contenu ?? '-' }}</dd>

            <dt class="col-sm-4">Nom</dt>
            <dd class="col-sm-8">{{ $role->nom_contenu ?? '-' }}</dd>
          </dl>

          <div class="d-flex justify-content-end">
            <a href="{{ route('typecontenu.index') }}" class="btn btn-secondary">Retour</a>
            <a href="{{ route('typecontenu.edit', $role->id_type_contenu) }}" class="btn btn-primary ms-2">Éditer</a>
          </div>
        </div>
      </div>
    </div>

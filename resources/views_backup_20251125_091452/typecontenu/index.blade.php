...
<html lang="fr">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('typecontenu.create') }}" class="btn btn-primary" title="Ajouter" aria-label="Ajouter"><i class="bi bi-plus-lg"></i></a>
  </div>
          ...
          <tbody>
            @forelse($types ?? [] as $type)
              <tr>
                ...
                <td>
                  <a href="{{ route('typecontenu.show', $type->id_type_contenu) }}" class="btn btn-sm btn-info" title="Voir" aria-label="Voir"><i class="bi bi-eye"></i></a>
                  <a href="{{ route('typecontenu.edit', $type->id_type_contenu) }}" class="btn btn-sm btn-warning" title="Éditer" aria-label="Éditer"><i class="bi bi-pencil"></i></a>
                  <form action="{{ route('typecontenu.destroy', $type->id_type_contenu) }}" method="POST" class="d-inline" onsubmit="return confirm('Supprimer ?');">
                    @csrf
                    @method('DELETE')

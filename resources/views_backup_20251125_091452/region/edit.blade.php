      ...
      <main class="app-main">
        <div class="container d-flex align-items-center" style="min-height:60vh;">
          <div class="row justify-content-center w-100">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header">Éditer la région</div>
                <div class="card-body">
                  @if ($errors->any())
                  ...
                  <form action="{{ route('region.update', $region->id_region) }}" method="POST">
                    ...
                    <div class="mb-3">
                      <label for="nom_region" class="form-label">Nom</label>
                      <input type="text" name="nom_region" id="nom_region" value="{{ old('nom_region', $region->nom_region) }}" class="form-control" required>
                    </div>

                    <div class="mb-3">
                      <label for="localisation" class="form-label">Localisation</label>
                      <input type="text" name="localisation" id="localisation" value="{{ old('localisation', $region->localisation) }}" class="form-control">
                    </div>

                    <div class="mb-3">
                      <label for="superficie" class="form-label">Superficie</label>
                      <input type="number" step="any" name="superficie" id="superficie" value="{{ old('superficie', $region->superficie) }}" class="form-control">
                    </div>

                    <div class="mb-3">
                      <label for="population" class="form-label">Population</label>
                      <input type="number" name="population" id="population" value="{{ old('population', $region->population) }}" class="form-control">
                    </div>

                    <div class="mb-3">
                      <label for="description" class="form-label">Description</label>
                      <textarea name="description" id="description" class="form-control" rows="4">{{ old('description', $region->description) }}</textarea>
                    </div>

                    <div class="d-flex justify-content-between">
                      <a href="{{ route('region.index') }}" class="btn btn-secondary" title="Annuler" aria-label="Annuler"><i class="bi bi-x-lg"></i></a>

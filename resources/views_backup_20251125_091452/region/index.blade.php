...
<html lang="fr">
  ...
  <div class="container-fluid">
    ...
    <h1>Régions</h1>
    <a href="{{ route('region.create') }}" class="btn btn-primary" title="Ajouter une région" aria-label="Ajouter une région"><i class="bi bi-plus-lg"></i></a>
  </div>
          ...
          <tbody>
            @forelse($regions  as $region)
              <tr>
                ...
                <td>
                  <a href="{{ route('region.show', $region->id_region) }}" class="btn btn-sm btn-info" title="Voir" aria-label="Voir"><i class="bi bi-eye"></i></a>
                  <a href="{{ route('region.edit', $region->id_region) }}" class="btn btn-sm btn-warning" title="Éditer" aria-label="Éditer"><i class="bi bi-pencil"></i></a>

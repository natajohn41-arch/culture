                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('region.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="nom_region" id="nom_region" value="{{ old('nom_region') }}" class="form-control" required>
                    </div>

                    <div class="mb-3">
                      <label for="localisation" class="form-label">Localisation</label>
                      <input type="text" name="localisation" id="localisation" value="{{ old('localisation') }}" class="form-control">
                    </div>

                    <div class="mb-3">
                      <label for="superficie" class="form-label">Superficie</label>
                      <input type="number" step="any" name="superficie" id="superficie" value="{{ old('superficie') }}" class="form-control">
                    </div>

                    <div class="mb-3">
                      <label for="population" class="form-label">Population</label>
                      <input type="number" name="population" id="population" value="{{ old('population') }}" class="form-control">
                    </div>

...
<html lang="fr">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    <div class="app-wrapper">
      ...
      </nav><nav class="app-header navbar navbar-expand bg-body">
  <div class="container-fluid">
    ...
    <ul class="navbar-nav ms-auto">
      ...
      <!-- Main Content -->
      <main class="app-main">
           <div class="container py-4 d-flex align-items-center" style="min-height:60vh;">
  <div class="row justify-content-center w-100">
    <div class="col-12 col-md-8">
      <div class="card">
        <div class="card-header"><h3 class="card-title">Modifier utilisateur</h3></div>
        <div class="card-body">
          ...
          <form action="{{ route('utilisateurs.update', $utilisateur->id_utilisateur) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input id="nom" name="nom" value="{{ old('nom', $utilisateur->nom) }}" type="text" class="form-control" required />
            </div>

            <div class="mb-3">
              <label for="prenom" class="form-label">Prénom</label>
              <input id="prenom" name="prenom" value="{{ old('prenom', $utilisateur->prenom) }}" type="text" class="form-control" required />
            </div>

            <div class="mb-3">
              <label for="email" class="form-label">Email</label>
              <input id="email" name="email" value="{{ old('email', $utilisateur->email) }}" type="email" class="form-control" required />
            </div>
            ...
            <div class="mb-3">
              <label for="id_role" class="form-label">Role (ID)</label>
              <input id="id_role" name="id_role" value="{{ old('id_role', $utilisateur->id_role) }}" type="number" class="form-control" />
            </div>

            <div class="mb-3">
              <label for="id_langue" class="form-label">Langue (ID)</label>
              <input id="id_langue" name="id_langue" value="{{ old('id_langue', $utilisateur->id_langue) }}" type="number" class="form-control" />
            </div>
            ...
            <div class="mb-3">
              ...
              <select id="sexe" name="sexe" class="form-select">
                ...
                <option value="O" {{ old('sexe', $utilisateur->sexe) == 'O' ? 'selected' : '' }}>Autre</option>
              </select>
            </div>

            <div class="mb-3">
              <label for="photo" class="form-label">Photo (URL ou fichier)</label>
              <input id="photo" name="photo" type="file" class="form-control" />
              @if(!empty($utilisateur->photo))
                <div class="mt-2">
                  <img src="{{ asset($utilisateur->photo) }}" alt="photo" style="max-width:120px;" />
                </div>
              @endif
            </div>
            ...
            <div class="mb-3">
              ...
              <input id="statut" name="statut" value="{{ old('statut', $utilisateur->statut) }}" type="text" class="form-control" />
            </div>

            <div class="mb-3">
              <label for="date_naissance" class="form-label">Date de naissance</label>
              <input id="date_naissance" name="date_naissance" value="{{ old('date_naissance', $utilisateur->date_naissance) }}" type="date" class="form-control" />
            </div>

            <div class="d-flex justify-content-between">
              <a href="{{ route('utilisateurs.index') }}" class="btn btn-secondary" title="Annuler" aria-label="Annuler"><i class="bi bi-x-lg"></i></a>
              <button type="submit" class="btn btn-primary" title="Enregistrer" aria-label="Enregistrer"><i class="bi bi-save"></i></button>
            </div>
          </form>

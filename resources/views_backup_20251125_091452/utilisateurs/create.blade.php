      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('utilisateurs.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              <label for="id_role" class="form-label">Rôle (ID)</label>
              <input type="number" name="id_role" id="id_role" value="{{ old('id_role') }}" class="form-control">
            </div>

            <div class="mb-3">
              <label for="id_langue" class="form-label">Langue (ID)</label>
              <input type="number" name="id_langue" id="id_langue" value="{{ old('id_langue') }}" class="form-control">
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" name="statut" id="statut" value="{{ old('statut') }}" class="form-control">
            </div>

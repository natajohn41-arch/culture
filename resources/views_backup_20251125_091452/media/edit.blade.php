      ...
      <main class="app-main">
        <div class="container d-flex align-items-center" style="min-height:60vh;">
          <div class="row justify-content-center w-100">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header">Éditer le média</div>
                <div class="card-body">
                  @if ($errors->any())
                  ...
                  <form action="{{ route('media.update', $media->id_media) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      <label for="chemin" class="form-label">Fichier (laisser vide pour conserver)</label>
                      <input type="file" name="chemin" id="chemin" class="form-control">
                    </div>

                    <div class="mb-3">
                      <label for="id_type_media" class="form-label">Type média (ID)</label>
                      <input type="number" name="id_type_media" id="id_type_media" value="{{ old('id_type_media', $media->id_type_media) }}" class="form-control">
                    </div>

                    <div class="mb-3">
                      <label for="id_contenu" class="form-label">Contenu (ID)</label>
                      <input type="number" name="id_contenu" id="id_contenu" value="{{ old('id_contenu', $media->id_contenu) }}" class="form-control">
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                      <a href="{{ route('media.index') }}" class="btn btn-secondary" title="Annuler" aria-label="Annuler"><i class="bi bi-x-lg"></i></a>

      ...
      <main class="app-main">
        <div class="container d-flex align-items-center" style="min-height:60vh;">
          <div class="row justify-content-center w-100">
            <div class="col-md-8">
              <div class="card">
                <div class="card-header">Ajouter un média</div>
                <div class="card-body">
                  @if ($errors->any())
                  ...
                  <form action="{{ route('media.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" name="id_type_media" id="id_type_media" value="{{ old('id_type_media') }}" class="form-control">
                    </div>

                    <div class="mb-3">
                      <label for="id_contenu" class="form-label">Contenu (ID)</label>
                      <input type="number" name="id_contenu" id="id_contenu" value="{{ old('id_contenu') }}" class="form-control">
                    </div>

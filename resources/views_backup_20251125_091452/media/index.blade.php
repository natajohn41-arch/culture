      ...
      <main class="app-main">
         <div class="container py-4">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h1>Médias</h1>
            <a href="{{ route('media.create') }}" class="btn btn-primary" title="Ajouter un média" aria-label="Ajouter un média"><i class="bi bi-plus-lg"></i></a>
          </div>
                ...
                <table class="table mb-0">
                  ...
                  <tbody>
                    @forelse($medias as $media)
                      <tr>
                        <td>{{ $media->chemin }}</td>
                        <td>{{ $media->id_type_media ?? '-' }}</td>
                        <td>{{ $media->id_contenu ?? '-' }}</td>
                        <td>{{ $media->description ?? '-' }}</td>
                        <td>
                          <a href="{{ route('media.show', $media->id_media) }}" class="btn btn-sm btn-info">Voir</a>
                          <a href="{{ route('media.edit', $media->id_media) }}" class="btn btn-sm btn-warning">Éditer</a>
                    ...
                    @empty
                      <tr>
                        <td colspan="6" class="text-center">Aucun média trouvé.</td>
                      </tr>
                    @endforelse
                  </tbody>
                </table>

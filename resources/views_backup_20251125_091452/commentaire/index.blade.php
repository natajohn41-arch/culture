...
<html lang="fr">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <h1>Commentaires</h1>
    <a href="{{ route('commentaire.create') }}" class="btn btn-primary" title="Ajouter un commentaire" aria-label="Ajouter un commentaire"><i class="bi bi-plus-lg"></i></a>
  </div>
          ...
          <tbody>
            @forelse($commentaires as $commentaire)
              <tr>
                ...
                <td>{{ $commentaire->id_contenu ?? '-' }}</td>
                 <td>{{ $commentaire->texte ?? '-' }}</td>
                  <td>{{ $commentaire->note ?? '-' }}</td>
                
                <td>{{ $commentaire->created_at ?? '-' }}</td>
                <td>
                  <a href="{{ route('commentaire.show', $commentaire->id_commentaire) }}" class="btn btn-sm btn-info" title="Voir" aria-label="Voir"><i class="bi bi-eye"></i></a>
                  <a href="{{ route('commentaire.edit', $commentaire->id_commentaire) }}" class="btn btn-sm btn-warning" title="Éditer" aria-label="Éditer"><i class="bi bi-pencil"></i></a>

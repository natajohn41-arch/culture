        ...
        <div class="card-body">
          ...
          <form action="{{ route('commentaire.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="id_contenu" id="id_contenu" value="{{ old('id_contenu') }}" class="form-control" required>
            </div>
            ...
            <div class="d-flex justify-content-between">
              <a href="{{ route('commentaire.index') }}" class="btn btn-secondary" title="Annuler" aria-label="Annuler"><i class="bi bi-x-lg"></i></a>

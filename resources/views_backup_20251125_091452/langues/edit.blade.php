                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('langues.update', $langue->id_langue) }}" method="POST">
                    ...
                    <div class="mb-3">
                      ...
                      <input id="code_langue" name="code_langue" value="{{ old('code_langue', $langue->code_langue) }}" type="text" class="form-control" />
                    </div>

                    <div class="mb-3">
                      <label for="nom_langue" class="form-label">Nom</label>
                      <input id="nom_langue" name="nom_langue" value="{{ old('nom_langue', $langue->nom_langue) }}" type="text" class="form-control" required />
                    </div>

                    <div class="mb-3">
                      <label for="description" class="form-label">Description</label>
                      <textarea id="description" name="description" class="form-control">{{ old('description', $langue->description) }}</textarea>
                    </div>

                    <div class="d-flex justify-content-between">
                      <a href="{{ route('langues.index') }}" class="btn btn-secondary" title="Annuler" aria-label="Annuler">
                        <i class="bi bi-arrow-left"></i>
                      </a>
                      <button type="submit" class="btn btn-primary" title="Mettre à jour" aria-label="Mettre à jour">

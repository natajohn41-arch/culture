            ...
            <div class="col-12">
              <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h3 class="card-title mb-0"><strong>Listes des langues</strong></h3>
                  <a href="{{ route('langues.create') }}" class="btn btn-primary" title="Ajouter une langue" aria-label="Ajouter une langue">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr class="align-middle">
                        ...
                        <td>
                          <a href="{{ route('langues.show', $langue->id_langue) }}" class="btn btn-sm btn-info" title="Afficher" aria-label="Afficher">
                            <i class="bi bi-eye"></i>
                          </a>
                          <a href="{{ route('langues.edit', $langue->id_langue) }}" class="btn btn-sm btn-secondary" title="Modifier" aria-label="Modifier">
                            <i class="bi bi-pencil"></i>
                          </a>
                          <form action="{{ route('langues.destroy', $langue->id_langue) }}" method="POST" style="display:inline-block" onsubmit="return confirm('Supprimer cette langue ?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-danger" title="Supprimer" aria-label="Supprimer">
                      ...
                      @empty
                      <tr>
                        <td colspan="4">Aucune langue trouvée.</td>
                      </tr>
                      @endforelse
                    </tbody>
                  </table>

            ...
            <div class="col-12 col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-3">
                    <a href="{{ route('langues.index') }}" class="btn btn-secondary" title="Retour à la liste" aria-label="Retour à la liste">
                      <i class="bi bi-arrow-left"></i>
                    </a>
                    <a href="{{ route('langues.edit', $langue->id_langue) }}" class="btn btn-primary" title="Modifier" aria-label="Modifier">

...
<html lang="fr">
  ...
  <div class="row justify-content-center w-100">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">Détails du contenu</div>
        <div class="card-body">
          <dl class="row">
            <dt class="col-sm-4">Titre</dt>
            <dd class="col-sm-8">{{ $contenu->titre ?? '-' }}</dd>

            <dt class="col-sm-4">Région (ID)</dt>
            <dd class="col-sm-8">{{ $contenu->id_region ?? '-' }}</dd>

            <dt class="col-sm-4">Date création</dt>
            <dd class="col-sm-8">{{ $contenu->date_creation ?? '-' }}</dd>

            <dt class="col-sm-4">Texte</dt>
            <dd class="col-sm-8">{{ $contenu->texte ?? '-' }}</dd>

            <dt class="col-sm-4">Statut</dt>
            <dd class="col-sm-8">{{ $contenu->statut ?? '-' }}</dd>

            <dt class="col-sm-4">Langue (ID)</dt>
            <dd class="col-sm-8">{{ $contenu->id_langue ?? '-' }}</dd>

            <dt class="col-sm-4">Auteur (ID)</dt>
            <dd class="col-sm-8">{{ $contenu->id_auteur ?? '-' }}</dd>

            <dt class="col-sm-4">Date validation</dt>
            <dd class="col-sm-8">{{ $contenu->date_validation ?? '-' }}</dd>

            <dt class="col-sm-4">Modérateur (ID)</dt>
            <dd class="col-sm-8">{{ $contenu->id_moderateur ?? '-' }}</dd>

            <dt class="col-sm-4">Parent (ID)</dt>
            <dd class="col-sm-8">{{ $contenu->parent_id ?? '-' }}</dd>
          </dl>

          <div class="d-flex justify-content-between">
            <a href="{{ route('contenu.index') }}" class="btn btn-secondary">Retour</a>
            <div>
              <a href="{{ route('contenu.edit', $contenu->id_contenu) }}" class="btn btn-primary me-2">Éditer</a>

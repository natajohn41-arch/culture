...
<html lang="fr">
  ...
  <div class="row justify-content-center w-100">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">Éditer le contenu</div>
        <div class="card-body">
          @if ($errors->any())
          ...
          <form action="{{ route('contenu.update', $contenu->id_contenu) }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="number" name="id_region" id="id_region" value="{{ old('id_region', $contenu->id_region) }}" class="form-control" required>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="number" name="id_langue" id="id_langue" value="{{ old('id_langue', $contenu->id_langue) }}" class="form-control" required>
            </div>

            <div class="mb-3">
              <label for="id_auteur" class="form-label">Auteur (ID)</label>
              <input type="number" name="id_auteur" id="id_auteur" value="{{ old('id_auteur', $contenu->id_auteur) }}" class="form-control" required>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="number" name="id_moderateur" id="id_moderateur" value="{{ old('id_moderateur', $contenu->id_moderateur) }}" class="form-control">
            </div>

            <div class="mb-3">
              <label for="parent_id" class="form-label">Parent (ID)</label>
              <input type="number" name="parent_id" id="parent_id" value="{{ old('parent_id', $contenu->parent_id) }}" class="form-control">
            </div>

            <div class="d-flex justify-content-between">
              <a href="{{ route('contenu.index') }}" class="btn btn-secondary" title="Annuler" aria-label="Annuler"><i class="bi bi-x-lg"></i></a>

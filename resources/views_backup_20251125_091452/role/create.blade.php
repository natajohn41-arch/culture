...
<html lang="fr">
  ...
  <div class="row justify-content-center w-100">
    <div class="col-md-6">
      <div class="card">
        <div class="card-header">Ajouter un rôle</div>
        <div class="card-body">
          @if($errors->any())
          ...
          <form action="{{ route('role.store') }}" method="POST">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="nom_role" id="nom_role" value="{{ old('nom_role') }}" class="form-control" required>
            </div>

            <div class="d-flex justify-content-end">
              <a href="{{ route('role.index') }}" class="btn btn-secondary me-2" title="Annuler" aria-label="Annuler"><i class="bi bi-x-lg"></i></a>

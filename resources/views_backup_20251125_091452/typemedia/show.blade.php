      ...
      <div class="card">
        ...
        <div class="card-body">
          <dl class="row">
            ...
            <dd class="col-sm-8">{{ $role->id_type_media ?? '-' }}</dd>

            <dt class="col-sm-4">Nom</dt>
            <dd class="col-sm-8">{{ $role->nom_media ?? '-' }}</dd>
          </dl>

          <div class="d-flex justify-content-end">
            <a href="{{ route('typemedia.index') }}" class="btn btn-secondary">Retour</a>
            <a href="{{ route('typemedia.edit', $role->id_type_media) }}" class="btn btn-primary ms-2">Éditer</a>
          </div>
        </div>
      </div>
    </div>

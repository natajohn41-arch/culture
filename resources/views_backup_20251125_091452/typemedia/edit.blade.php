    ...
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="{{ route('typemedia.update', $role->id_type_media) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-3">
              <label for="nom_media" class="form-label">Nom</label>
              <input type="text" name="nom_media" id="nom_media" value="{{ old('nom_media', $role->nom_media) }}" class="form-control" required>
            </div>

            <div class="d-flex justify-content-end">
              <a href="{{ route('typemedia.index') }}" class="btn btn-secondary me-2" title="Annuler" aria-label="Annuler"><i class="bi bi-x-lg"></i></a>

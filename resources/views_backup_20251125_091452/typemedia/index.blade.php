...
<html lang="fr">
  ...
  <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <h1>Types de média</h1>
    <a href="{{ route('typemedia.create') }}" class="btn btn-primary" title="Ajouter" aria-label="Ajouter"><i class="bi bi-plus-lg"></i></a>
  </div>
          ...
          <tbody>
            @forelse($types ?? [] as $type)
              <tr>
                ...
                <td>
                  <a href="{{ route('typemedia.show', $type->id_type_media) }}" class="btn btn-sm btn-info" title="Voir" aria-label="Voir"><i class="bi bi-eye"></i></a>
                  <a href="{{ route('typemedia.edit', $type->id_type_media) }}" class="btn btn-sm btn-warning" title="Éditer" aria-label="Éditer"><i class="bi bi-pencil"></i></a>
                  <form action="{{ route('typemedia.destroy', $type->id_type_media) }}" method="POST" class="d-inline" onsubmit="return confirm('Supprimer ?');">
                    @csrf
                    @method('DELETE')

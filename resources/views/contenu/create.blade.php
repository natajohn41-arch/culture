            ...
            <div class="card">
                <div class="card-header bg-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ Auth::user()->isAuthor() ? route('mes.contenus.index') : route('contenus.index') }}" class="btn btn-outline-secondary btn-sm">
                ...
                <div class="card-body">
                    ...
                    <!-- FORMULAIRE AVEC LA BONNE ROUTE -->
                    <form action="{{ Auth::user()->isAuthor() ? route('mes.contenus.store') : route('contenus.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @else
                                            <!-- Champ caché pour le statut des auteurs -->
                                ...
                                <div class="d-grid gap-2 mt-4">
                                    ...
                                    <a href="{{ Auth::user()->isAuthor() ? route('mes.contenus.index') : route('contenus.index') }}" class="btn btn-outline-secondary">
...
document.getElementById('medias').addEventListener('change', function(e) {
    ...
    if (files.length > 0) {
        ...
        html += files.length + ' fichier(s) sélectionné(s) :';
        html += '</div>';
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card border">
                            <div class="card-img-top bg-light d-flex align-items-center justify-content-center" 
                                 style="height: 100px;">
                                <i class="bi bi-play-circle text-primary display-6"></i>
                            </div>
                            <div class="card-body p-2">
                                <small class="d-block text-truncate">${file.name}</small>
                                <small class="text-muted">Vidéo • ${(file.size / 1024 / 1024).toFixed(2)} MB</small>
                            </div>
                        </div>
                    </div>
                `;
                ...
                html += `
                    <div class="col-md-3 col-6">
                        <div class="card border">
                            <div class="card-img-top bg-light d-flex align-items-center justify-content-center" 
                                 style="height: 100px;">
                                <i class="bi bi-file-earmark text-secondary display-6"></i>
                            </div>
                            <div class="card-body p-2">
                                <small class="d-block text-truncate">${file.name}</small>
                                <small class="text-muted">Document • ${(file.size / 1024 / 1024).toFixed(2)} MB</small>
                            </div>
                        </div>
                    </div>
                `;

                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            @foreach($mesContenus as $contenu)
                                <tr>
                                    <td>
                                        <!-- CORRECTION ICI : Utilisez mes.contenus.show au lieu de contenu.show -->
                                        <a href="{{ route('mes.contenus.show', $contenu->id_contenu) }}" class="text-decoration-none">
                                    ...
                                    <td>
                                        <small class="text-muted">
                                            {{ $contenu->date_creation ? $contenu->date_creation->format('d/m/Y') : '-' }}
                                        </small>
                                    </td>
                                    <td>
                                        <span class="badge bg-info">{{ $contenu->commentaires->count() ?? 0 }}</span>
                                    </td>
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <!-- CORRECTION ICI : Utilisez mes.contenus.show -->
                                            <a href="{{ route('mes.contenus.show', $contenu->id_contenu) }}" 

    ...
    <ul class="navbar-nav ms-auto">
     ...
     <!--begin::Horizontal Form-->
                <div class="card card-warning card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Formulaire</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->

          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-header">LABELS</li>
                <!-- Début menu personnalisé -->
                <li class="nav-header">MES DOSSIERS</li>
                <li class="nav-item">
                  <a href="{{ route('contenus.index') }}" class="nav-link {{ request()->is('contenus*') ? 'active bg-primary text-white' : '' }}">
                    <i class="nav-icon bi bi-file-earmark-text"></i>
                    <p>Contenu</p>
                  </a>
                </li>
                <!-- Ajoutez ici d'autres dossiers (region, langues, etc.) -->
            </ul>
            <!--end::Sidebar Menu-->
          </nav>
        </div>
